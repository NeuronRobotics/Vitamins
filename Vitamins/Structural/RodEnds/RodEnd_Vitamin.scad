 ...
 union()
	{
		...
		translate([0,0,-MotorScrewBoltLength()/8])
		{
			rotate([0,180,0])
			{
				#MotorScrewBolt();
		...
		{
			#cube([ RodEndBallSwivelFlangeDiam(3dPrinterTolerance), 
					RodEndTopWidth(3dPrinterTolerance), 
					RodEndBallSwivelFlangeHeight(3dPrinterTolerance)-.8]);
		}
